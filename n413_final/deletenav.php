...
<link href="https://fonts.googleapis.com/css2?family=Righteous&display=swap" rel="stylesheet">
    ...
    <body>
        <nav class="navbar navbar-expand-lg">
             <a class="navbar-brand" href="index.php">Wishing Well</a>
                  ...
                  <ul class="navbar-nav">
                      ...
                      echo '
                                ...
                                <li id="wishes_item" class="nav-item">
                                    <a id="wishes_link" class="nav-link" href="anonhome.php">Browse</a>
                                </li>                           
                                <li id="profile_item" class="nav-item">
                                    <a id="profile_link" class="nav-link" href="login.php">Login</a>
                                </li>
                                <li id="logout_item" class="nav-item">
                                    <a id="logout_link" class="nav-link" href="signup.php">Signup</a>
                                </li>';
                                }else{
                                echo '        
