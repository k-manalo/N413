        ...
        <body>
            ...
            foreach ($records as $record){
                ...
                <div style="display: flex; padding-left: 15px; padding-right: 15px;">
                    ...
                    <div class="desc" style="border: 2px solid black; padding: 10px;"> <h3>'.$record["item"].'</h3> <div style="background-color: black; height: 2px; width: 500px;"></div> <br> '.$record["description"].'</div>
                </div><br>';
            }
            ?>
        </body>
